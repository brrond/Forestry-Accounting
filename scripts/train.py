...
parser.add_argument('--y-data', '-yd', type=str, required=True, help='y_data folder path')
parser.add_argument('--x-data-t', '-xdt', type=str, required=True, help='x_data folder path for test/validation')
parser.add_argument('--y-data-t', '-ydt', type=str, required=True, help='y_data folder path for test/validation')
